...
Realmente, la configuración de ejecutarse en EL1 tiene más implicaciones pero la herramienta de Xilinx abstrae de las mismas al desarrolador. Cuando se genera una aplicación en \acrshort{XSDK} se necesita un \acrshort{BSP}
