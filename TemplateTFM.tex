...
\begin{thebibliography}{00}
	...
	\bibitem{armv8_virt_review} Sergey Temerkhanov \& Igor Pochinok, \emph{Understanding virtualization facilities in the ARMv8 processor architecture}. https://www.embedded.com/design/mcus-processors-and-socs/4461129/1/Understanding-virtualization-facilities-in-the-ARMv8-processor-architecture
	...
	\bibitem{okl4_2} https://gdmissionsystems.com/-/media/General-Dynamics/Cyber-and-Electronic-Warfare-Systems/PDF/Data-Sheets/okl4-hypervisor-datasheet.ashx?la=en
	\bibitem{windriver_1} WindRiver Hypervisor Product Note https://www.windriver.com/products/product-notes/wind-river-hypervisor-product-note.pdf
	\bibitem{hyper-v} https://docs.microsoft.com/es-es/virtualization/hyper-v-on-windows/about/
	\bibitem{jailhouse_github} https://github.com/siemens/jailhouse
	\bibitem{vmware} https://www.vmware.com/products/esxi-and-esx.html
	\bibitem{seL4} https://sel4.systems/
	\bibitem{armv8_el} https://developer.arm.com/docs/100878/latest/changing-exception-levels
