...
\begin{itemize}
  \item En caso de necesitar sobreutilización de recursos y flexibilidad, no queda otra opción que decantarse por Xen, ya que Jailhouse no ofrece esa opción. No se puede tampoco olvidar que la sobreutilización de recursos necesita de mecanimos de paravirtualización y el rendimiento en esta modalidad es inferior.
