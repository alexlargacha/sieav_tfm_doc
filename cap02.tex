...
Más adelante se detallarán las características de la asistencia a la virtualización (extensiones de virtualización según ARM \cite{armv8_virt}), pero resumiendo, la clave para dar cabida a la virtualización en la arquitectura ARM es la inclusión de un nuevo nivel de privilegio en la CPU, o nivel de excepción (EL) en la nomenclatura ARM. Este nuevo nivel de excepción, EL2, se añade a los ya existentes de usuario y de kernel, EL0 y EL1 respectivamente.
