...
KVM permite la ejecución de distintos sitemas operativos \cite{kvm_list} sin requerir modificaciones en los mismos y tiene versiones para las arquitecturas x86, x8664, MIPS, PowerPC y ARM con distinto grado de oficialidad.
